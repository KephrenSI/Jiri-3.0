<template>
    <main class="contentView">
        <h2 class="heading2 hidden" role="heading" aria-level="2">Judges</h2>
        <add-judges></add-judges>
        <search-judges></search-judges>
        <ul class="list">
            <li class="list__el">
                <img v-for="image in images" :src="image.url" :alt="image.name" class="list__el--infos list__el--pic">
                <p class="list__el--infos list__el--name">Dominique Vilain</p>
                <p class="list__el--infos list__el--email">domi.vilain@hepl.be</p>
                <p class="list__el--infos list__el--agency">HEPL</p>
