        ...
        <ul class="list">
            <li class="list__el">
                ...
                <p class="list__el--infos list__el--description">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus et fermentum enim, in aliquet orci. Etiam pellentesque nulla sapien, ac varius arcu tempus in.
                </p>
